    ...
    node.innerHTML = `
          <input type="checkbox" class="checkbox" id="checkbox-${todo.id}" name="${todo.id}">
           <label class="todos-list__li" for="${todo.id}">
             ...
             <div class="todos-list__li-icon">
                <img src="/img/checkbox.svg" alt="checkbox" class="todos-list__li-icon-1"/>
                   ...
                   <svg class="todos-list__li-icon-2" width="30" height="25" viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <div class="todos-list__li-text">
                ...
                <svg class="todos-list__li-text-2" width="194" height="4" viewBox="0 0 194 4" fill="none" xmlns="http://www.w3.org/2000/svg">
...
list.addEventListener('click', event => {
    ...
    if (event.target.classList.contains('todos-list__li-delete-todo')) {
        ...
        if (event.target.parentNode.parentNode.classList.contains('checked')) {
            ...
            console.log("cehceeeeeeeekkkkkkkkkkkeeeeeddddddd" + document.getElementById("checkbox-" + itemKey).checked);
        }
        else {
...
function toggleDone(key) {
    ...
    // document.querySelector('input[type="checkbox"]').setAttribute('checked', todoItems[index].checked);

    console.log('Checked - 2 : ' + todoItems[index].checked);
